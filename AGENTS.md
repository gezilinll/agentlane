...
| Skill target resolution | `docs/product/skill-management-spec.md`, `src/skills/skill-effective.ts`, `src/skills/skill-governance-store.ts` | `src/skills/skill-effective.test.ts`, `src/skills/skill-governance-store.test.ts`, `npm run check:backend` |
