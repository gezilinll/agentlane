...
- `src/skills/skill-http-api.ts`: organization-scoped Skill import, discovered target Skill promotion, draft-version edit, archive, draft delete, list, detail, and version-file HTTP API.
